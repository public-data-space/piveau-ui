      ...
      <div class="col-8">
        ...
        >
          ...
          <button
            ...
            @click="console.log('@CLICKED ALERT LINK')"
          >
        ...
        <div class="card">
          <a
            class="bg-primary d-flex justify-content-start"
          ...
          >
            <div class="map card-body">
              <map-basic
                width="100%"
                height="400px"
                :bounds="[[52.27, 12.91], [52.77, 13.91]]"
              />
            </div>
          </div>
        </div>
        <section class="distributions card border-0 mt-3">
          <h4 class="card-header border-0 bg-transparent">
            {{ getDistributions.length }} Distributions
          </h4>
          <data-info-box
            v-for="(distribution, i) in getDistributions"
            :key="distribution.id"
            class=""
            :collapse="true"
            :collapse-id="i"
          ...
          <div class="card-body">
            ...
            >
              <dl>
                ...
                >
                <dd class="">
                  <strong>{{ getPublisher.name|| '-' }}</strong>
                </dd>
