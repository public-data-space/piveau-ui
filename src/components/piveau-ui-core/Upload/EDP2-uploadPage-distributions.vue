    ...
    <div class="row mb-3">
      ...
      <div class="col-10 py-2 text-left">
        <h3
          ...
          @click="toggleDistribution()"
        >
          {{ $t('message.metadata.distribution') }}
        </h3>
      </div>
      <div
        v-if="distributionVisible"
      ...
      >
        ...
        <div class="input-group mb-2">
          ...
          >
            <option disabled>
              {{ $t('message.metadata.chooseFormat') }} ...
            </option>
            <option
              selected
              value=""
            ...
            <option
              v-for="format in formatVocabulary"
              :value="format"
            >
        ...
        <div class="custom-control custom-checkbox w-100">
          <input
            ...
            @click="useDownloadURL = !useDownloadURL"
          >
          <label
            for="useDownloadURL"
    ...
    >
      <div class="col-12">
        <div class="row mb-5">
          <div
            class="col-1 my-auto pr-0 text-right"
            @click="toggleDistributionList()"
          >
            <span
              v-if="!distributionListVisible"
              class="arrow text-primary"
            >
              <b-icon-chevron-down
                scale="1.5"
          ...
          <div class="col-10 py-2 text-left">
            <h3
              ...
              @click="toggleDistributionList()"
            >
              {{ $t('message.metadata.distributions') }} ( {{ distributions.length }} )
            </h3>
          </div>
          <div
              ...
              <span class="col-10">
                <span class="row">
                  ...
                  <span class="d-inline-block col-1">
                    ...
                    >{{ $t('message.datasetDetails.edit') }}</button>
                  </span>
                  <span class="d-inline-block col-1">
                    <button
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="col-10 offset-1">
              ...
              <div class="input-group mb-2">
                ...
                >
                <div
                  v-if="errors.first('UpdateDownloadURL')"
                  class="invalid-feedback"
                >
          ...
          <div class="modal-footer">
            ...
            <button
              ...
              data-dismiss="modal"
              class="btn btn-primary"
              @click="updateDistribution(distributionEdit)"
            >
              Update
            </button>
          </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button
              ...
              data-dismiss="modal"
              class="btn btn-primary"
              @click="deleteDistribution(distributionEdit)"
            >
              Yes
            </button>
          </div>
...
<script>
  ...
  import fileTypes from '@/assets/MDR_fileTypes.json';
