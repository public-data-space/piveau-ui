<template>
  <div>
    <p
      v-for="fieldId in Object.keys(selectedFacets)"
    ...
    >
      ...
      <span
        v-for="(facetId, i) in selectedFacets[fieldId]"
        :key="i"
        class="badge badge-pill badge-highlight mr-1"
      >
        {{ findFacetTitle(fieldId, facetId) }}
        <span
          class="close-facet ml-2"
          @click="removeSelectedFacet(fieldId, facetId)"
        >&times;</span>
      </span>
    </p>
  </div>
