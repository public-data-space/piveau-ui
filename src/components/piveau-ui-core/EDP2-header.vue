<template>
  <div
    id="edp2-header"
    class="edp2-topnav-wrapper container-fluid mb-3"
  >
    <div class="row edp2-header">
      <div class="col-auto">
        <app-link
          class="edp2-home-link"
          :path="`/${$i18n.locale}`"
        >
          <div class="mt-3 d-flex flex-row">
            <img
              class="edp-logo ml-3"
              src="../assets/img/edplogo.png"
              alt="European data portal logo"
            >
            <div class="edp-title d-flex flex-column ml-3 mt-1">
              <div class="edp-title-top">
                {{ $t('message.header.european') }}
              </div>
              <div class="edp-title-bottom">
                {{ $t('message.header.dataPortal') }}
              </div>
            </div>
          </div>
        </app-link>
          ...
          <div class="col justify-content-end">
            <ul class="nav subnav justify-content-end mt-1 d-none d-lg-flex position-absolute fixed-top">
              <li class="nav-item small">
                <app-link
                  class="nav-link px-0 py-3 py-md-1"
              ...
              <li
                v-if="this.$env.useAuthService && this.$env.keycloak.enableLogin"
                class="nav-item small"
              >
                <!--<a v-if="!authenticated" @click="$router.push(`/login?locale=${$i18n.locale}`)" class="nav-link px-0 py-3 py-md-1 login">{{ $t('message.header.subnav.login') }}</a>-->
                <a
                  v-if="!authenticated"
                  class="nav-link px-0 py-3 py-md-1 login"
                  @click="login()"
                >{{ $t('message.header.subnav.login') }}</a>
                <a
                  v-if="authenticated"
                  class="nav-link px-0 py-3 py-md-1 login"
                  @click="logout()"
                >{{ $t('message.header.subnav.logout') }}</a>
              </li>
            </ul>
          </div>
    ...
    <div class="row edp2-breadcrumb d-none d-md-block">
      ...
      <small v-if="showDatasetDetailsDataset || showDatasetDetailsCategories || showDatasetDetailsSimilarDatasets || showDatasetDetailsActivityStream">
        <span class="edp2-breadcrumb-arrow">></span>
        <app-link
          class="edp2-breadcrumb-link text-truncate"
    ...
    <div class="row">
      <nav class="navbar navbar-expand-md w-100 h-100 p-0 edp2-topnav">
        <app-link
          class="navbar-brand p-0 m-0 d-none d-md-block edp2-topnav-home"
          :path="`/${$i18n.locale}`"
        >
        ...
        <ul class="navbar-nav nav-fill w-100 h-100 justify-content-between flex-row d-none d-md-flex">
          <li class="nav-item dropdown edp2-topnav-dropdown">
            ...
            <div
              class="dropdown-menu border-0 w-100 mt-0 edp2-topnav-dropdown-container"
              aria-labelledby="edp2-topnav-dropdown-1"
            >
              <ul class="d-flex flex-row justify-content-center px-3">
                <li class="dropdown-item p-0 mx-1">
                  <app-link
                    class="nav-link btn rounded edp2-topnav-dropdown-button"
      ...
      <nav class="navbar navbar-expand-md w-100 edp2-topnav-mobile d-md-none d-flex justify-content-end">
        <button
          class="navbar-toggler rounded collapsed"
          type="button"
